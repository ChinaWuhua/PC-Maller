...
module.exports = function (email, data, customerName, orderID, date) {
  if (!email) {
    return 
  }
  let tableData = ``
  ...
  let mailOptions = {
    from: '<example@163.com>', // 发送方
    to: email, //接收者邮箱，多个邮箱用逗号间隔
    subject: `Farmer Mall - You have new order`, // 标题
    ...
    html: `
      ...
      <body tabindex="0" role="listitem">
        <div style="width:100%;margin:0 auto;border-bottom:1px solid #ccc;margin-bottom:30px;">
        ...
        <div style="width:90%;padding:0 10px;margin:0 auto;">
